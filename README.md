...
```groovy
dependencies {
  implementation 'com.mobilejazz:harmony-kotlin:3.0.2'
}
```
Or if you need to use it on a particular platform you can use the following artifacts
```groovy
  implementation 'com.mobilejazz:harmony-kotlin-ios:3.0.2'
  implementation 'com.mobilejazz:harmony-kotlin-android:3.0.2'
  implementation 'com.mobilejazz:harmony-kotlin-jvm:3.0.2'
```
