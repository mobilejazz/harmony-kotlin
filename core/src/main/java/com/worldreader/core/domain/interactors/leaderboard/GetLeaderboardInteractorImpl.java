...
public class GetLeaderboardInteractorImpl extends AbstractInteractor<LeaderboardStats, ErrorCore>
    implements GetLeaderboardInteractor {
  ...
  @Inject public GetLeaderboardInteractorImpl(InteractorExecutor executor, MainThread mainThread,
      LeaderboardRepository leaderboardRepository) {
    super(executor, mainThread);
    this.leaderboardRepository = leaderboardRepository;
  }

  @Override public void execute(LeaderboardPeriod period, int offset,
  ...
  @Override public void run() {
    leaderboardRepository.getLeaderboardStats(convertToRepositoryPeriod(period), page,
        new CompletionCallback<LeaderboardStats>() {
  ...
  private static LeaderboardRepository.LeaderboardPeriod convertToRepositoryPeriod(
      GetLeaderboardInteractor.LeaderboardPeriod period) {
    switch (period) {
      case GLOBAL:
      default:
