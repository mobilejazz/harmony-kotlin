...
@PerActivity public class GetWordDefinitionInteractor {

  private final ListeningExecutorService executor;
  private final DictionaryRepository repository;

  @Inject public GetWordDefinitionInteractor(ListeningExecutorService executor, DictionaryRepository dictionaryRepository) {
