...
@Singleton public class PutAllUserMilestonesInteractor {
  ...
  @Inject public PutAllUserMilestonesInteractor(final ListeningExecutorService executor,
  ...
  public ListenableFuture<Optional<List<UserMilestone>>> execute(
      final PutUserMilestonesStorageSpec spec, final List<UserMilestone> userMilestones) {
  ...
  private Runnable getStorageInteractorRunnable(
      final SettableFuture<Optional<List<UserMilestone>>> future,
      final PutUserMilestonesStorageSpec spec, final List<UserMilestone> milestones) {
