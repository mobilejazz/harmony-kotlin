...
public class UserFlow {
  ...
  private UserFlow(Type type, int phase, boolean isDisplayed) {
    this.type = type;
    this.phase = phase;
    this.isDisplayed = isDisplayed;
  }

  public static UserFlow create(Type type, int phase, boolean isDisplayed) {
    return new UserFlow(type, phase, isDisplayed);
  }
