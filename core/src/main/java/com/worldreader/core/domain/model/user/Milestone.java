...
public class Milestone {
  ...
  public static final Milestone NONE = new Milestone(0, "", 0, null, null);
  ...
  public Milestone(int id, String description, int points, State state, Metadata metadata) {
    this.id = id;
  ...
  public static Milestone updateTo(State state, Milestone milestone) {
    return new Milestone(milestone.getId(), milestone.getDescription(), milestone.getPoints(),
