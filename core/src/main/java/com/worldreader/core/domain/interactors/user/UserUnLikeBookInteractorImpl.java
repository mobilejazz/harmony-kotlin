...
public class UserUnLikeBookInteractorImpl extends AbstractInteractor<Boolean, ErrorCore<?>>
  ...
  @Inject public UserUnLikeBookInteractorImpl(InteractorExecutor executor, MainThread mainThread, UnlikeBookInteractor unlikeBookInteractor) {
  ...
  @Override public void run() {
    Futures.addCallback(unlikeBookInteractor.execute(bookId),
