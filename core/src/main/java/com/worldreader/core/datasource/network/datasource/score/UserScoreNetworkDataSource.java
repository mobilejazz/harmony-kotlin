...
public class UserScoreNetworkDataSource
    implements Repository.Network<UserScoreEntity, UserScoreNetworkSpecification> {

  private final UserApiService2 apiService;
  private final ErrorAdapter<Throwable> errorAdapter;

  @Inject public UserScoreNetworkDataSource(final UserApiService2 apiService,
      final ErrorAdapter<Throwable> errorAdapter) {
    this.apiService = apiService;
    this.errorAdapter = errorAdapter;
  }

  @Override public void get(final UserScoreNetworkSpecification specification,
      final Callback<Optional<UserScoreEntity>> callback) {
    throw new UnsupportedOperationException("get() not supported");
  }

  @Override public void getAll(final UserScoreNetworkSpecification specification,
  ...
  @Override public void put(final UserScoreEntity userScoreEntity,
      final UserScoreNetworkSpecification specification,
      final Callback<Optional<UserScoreEntity>> callback) {
