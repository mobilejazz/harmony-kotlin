...
public class SignOutAnalyticsEvent implements AnalyticsEvent {
  ...
  private SignOutAnalyticsEvent(Builder builder) {
  ...
  public static final class Builder {
    ...
    public SignOutAnalyticsEvent build() {
      return new SignOutAnalyticsEvent(this);
    }
  }
}
