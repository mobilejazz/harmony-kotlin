...
public final class AmazonMobileAnalyticsConstants {
  ...
  public static final String BOOK_ADD_COLLECTION_TO_LIBRARY_EVENT = "AddCollectionToLibrary";
  ...
  public static final String MORE_BOOKS_LIBRARY_EVENT = "More_Books_Library";
  ...
  public static final String PARENT_CATEGORY_TITLE = "ParentCategoryTitle";
  ...
  public static final String SEARCH_RESULT_SIZE ="SearchResultsSize";
