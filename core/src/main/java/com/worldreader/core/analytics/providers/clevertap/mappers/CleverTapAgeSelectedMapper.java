...
public class CleverTapAgeSelectedMapper implements CleverTapAnalyticsMapper<AgeSelectedAnalyticsEvent> {

  private final SharedPreferences preferences;

  public CleverTapAgeSelectedMapper(Context context) {
    preferences = context.getSharedPreferences("wr-preferences", Context.MODE_PRIVATE);
  }

  @Override public Map<String, Object> transform(final AgeSelectedAnalyticsEvent event) {
    return new HashMap<String, Object>() {{
      put(CleverTapEventConstants.CLEVERTAP_KEY_EVENT_NAME, CleverTapEventConstants.AGE_SELECTED_EVENT);
      put(CleverTapEventConstants.AGE_SELECTED_ATTRIBUTE, event.getAgeSelected());
