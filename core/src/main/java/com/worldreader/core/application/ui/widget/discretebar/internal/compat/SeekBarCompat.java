...
import com.worldreader.core.application.ui.widget.discretebar.internal.drawable.AlmostRippleDrawable;
...
public class SeekBarCompat {
  ...
  public static boolean isInScrollingContainer(ViewParent p) {
    return Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH && SeekBarCompatDontCrash
        .isInScrollingContainer(p);
  }

  public static boolean isHardwareAccelerated(View view) {
    return Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB
        && SeekBarCompatDontCrash.isHardwareAccelerated(view);
  }
}