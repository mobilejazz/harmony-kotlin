...
package com.worldreader.core.application.ui.widget.discretebar.internal;
...
public class PopupIndicator {
   ...
   * We may/should change this in the future to use just the PARENT View width and/or pass it in
   * the
   * constructor
   */
   ...
   * You typically calls this when the parent view is being removed from the window to avoid a
   * Window Leak
   */
