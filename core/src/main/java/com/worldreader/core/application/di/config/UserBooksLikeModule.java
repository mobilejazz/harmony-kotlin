...
@Module public class UserBooksLikeModule {
  ...
  static UserBooksLikeRepository provideUserBooksLikeRepository(NetworkRepositoryProvider<UserBooksLikeNetworkDataSource> networkRepositoryProvider,
      ...
      Repository.Storage<UserBookLikeEntity, UserBookLikeStorageSpec> storage, Repository.Storage<UserEntity2, RepositorySpecification>
      userStorage, ListUserBookLikeToListUserBookLikeEntityMapper toListUserBookLikeMapper) {
    return new UserBooksLikeDataSource(networkRepositoryProvider, storage, userStorage, toUserBookMapper, toUserBookListMapper, toListUserBookLikeMapper);
  }
