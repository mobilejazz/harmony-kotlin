 ...
 */
package com.worldreader.core.application.ui.adapter.manager;
 ...
 * {@link #setChildSize(int)} method might be used to let the layout manager know how big they are
 * going to be.
 * If animations are not used at all then a normal measuring procedure will run and child views
 * will
 * be measured during
 * the measure pass.
 */
public class FixedSizeLinearLayoutManager extends android.support.v7.widget.LinearLayoutManager {
  ...
  @SuppressWarnings("UnusedDeclaration") public FixedSizeLinearLayoutManager(Context context) {
    super(context);
    this.view = null;
  }
  ...
  @SuppressWarnings("UnusedDeclaration") public FixedSizeLinearLayoutManager(RecyclerView view) {
  ...
  @SuppressWarnings("UnusedDeclaration")
  public FixedSizeLinearLayoutManager(RecyclerView view, int orientation, boolean reverseLayout) {
  ...
  public void onMeasure(RecyclerView.Recycler recycler, RecyclerView.State state, int widthSpec,
    ...
    if (view != null && overScrollMode == ViewCompat.OVER_SCROLL_IF_CONTENT_SCROLLS) {
      final boolean fit =
          (vertical && (!hasHeightSize || height < heightSize)) || (!vertical && (!hasWidthSize
              || width < widthSize));
