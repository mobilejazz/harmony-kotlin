...
package com.worldreader.reader.wr.helper.systemUi;
...
@TargetApi(Build.VERSION_CODES.JELLY_BEAN) class SystemUiHelperImplJB extends SystemUiHelperImplICS {
  ...
  @Override protected int createShowFlags() {
  ...
  @Override protected void onSystemUiShown() {
  ...
  @Override protected void onSystemUiHidden() {
    if (mLevel == SystemUiHelper.LEVEL_LOW_PROFILE) {
