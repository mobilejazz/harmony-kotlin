...
public class TasksFactory {
  ...
  public static QueueableAsyncTask<Void, Void, Pair<Book, PageTurnerSpine>> createOpenBookTask(Context context, BookMetadata bm, TextLoader tl, int index, Logger logger) {
