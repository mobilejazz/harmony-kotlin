...
public class NavigationHistory implements NavigationEventListener {
  ...
  private static class Location {
    ...
    @SuppressWarnings("unused") public void setHref(String href) {
      this.href = href;
    }
   ...
   * When a user is rapidly viewing many pages using the slider we do not want all of them to be
   ...
   * If the currentposition is not the end of the list then the elements between the current element
   * and the end of the list will be discarded.
   ...
   *
   * @return Whether we actually moved. If the requested value is illegal it will return false, true
   * otherwise.
   */
