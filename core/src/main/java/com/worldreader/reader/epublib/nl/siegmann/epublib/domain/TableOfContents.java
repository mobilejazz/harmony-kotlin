...
public class TableOfContents implements Serializable {
   ...
   *
   * Example:
   * Calling this method with a Resource and new String[] {"chapter1", "paragraph1"} will result in
   * the following:
   * <ul>
   * <li>a TOCReference with the title "chapter1" at the root level.<br/>
   * If this TOCReference did not yet exist it will have been created and does not point to any
   * resource</li>
   * <li>A TOCReference that has the title "paragraph1". This TOCReference will be the child of
   * TOCReference "chapter1" and
   ...
   * If this TOCReference did not yet exist it will have been created with a title of "" and does
   * not point to any resource</li>
  ...
  public TOCReference addSection(Resource resource, int[] pathElements, String sectionTitlePrefix,
    ...
    for (int i = 0; i < pathElements.length; i++) {
      ...
      if (result == null) {
        paddTOCReferences(currentTocReferences, pathElements, i, sectionTitlePrefix,
  ...
  private void paddTOCReferences(List<TOCReference> currentTocReferences, int[] pathElements,
      int pathPos, String sectionPrefix, String sectionNumberSeparator) {
