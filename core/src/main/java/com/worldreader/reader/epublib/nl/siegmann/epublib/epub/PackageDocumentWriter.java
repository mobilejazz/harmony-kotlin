...
public class PackageDocumentWriter extends PackageDocumentBase {
  ...
  public static void write(EpubWriter epubWriter, XmlSerializer serializer, Book book)
    ...
    try {
      ...
      serializer.attribute(EpubWriter.EMPTY_NAMESPACE_PREFIX, OPFAttributes.uniqueIdentifier,
          BOOK_ID_ID);
   ...
   */
  private static void writeSpine(Book book, EpubWriter epubWriter, XmlSerializer serializer)
    ...
    if (book.getCoverPage() != null // there is a cover page
      ...
      serializer.attribute(EpubWriter.EMPTY_NAMESPACE_PREFIX, OPFAttributes.idref,
  ...
  private static void writeManifest(Book book, EpubWriter epubWriter, XmlSerializer serializer)
      throws IllegalArgumentException, IllegalStateException, IOException {
    ...
    serializer.attribute(EpubWriter.EMPTY_NAMESPACE_PREFIX, OPFAttributes.media_type,
  ...
  private static void writeItem(Book book, Resource resource, XmlSerializer serializer)
      throws IllegalArgumentException, IllegalStateException, IOException {
    if (resource == null || (resource.getMediaType() == MediatypeService.NCX
  ...
  private static void writeGuide(Book book, EpubWriter epubWriter, XmlSerializer serializer)
      throws IllegalArgumentException, IllegalStateException, IOException {
  ...
  private static void ensureCoverPageGuideReferenceWritten(Guide guide, EpubWriter epubWriter,
    ...
    if (coverPage != null) {
      writeGuideReference(
          new GuideReference(guide.getCoverPage(), GuideReference.COVER, GuideReference.COVER),
          serializer);
    }
  }
  ...
  private static void writeGuideReference(GuideReference reference, XmlSerializer serializer)
    ...
    if (StringUtil.isNotBlank(reference.getTitle())) {
      serializer.attribute(EpubWriter.EMPTY_NAMESPACE_PREFIX, OPFAttributes.title,
          reference.getTitle());
    }
