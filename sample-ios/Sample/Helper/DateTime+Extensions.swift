...
extension Kotlinx_datetimeLocalDateTime {
    func toString() -> String {
        return "\(self.dayOfMonth)/\(self.monthNumber)/\(self.year) \(self.addLeadingZeros(int: self.hour)):\(self.addLeadingZeros(int: self.minute))"
    }

    private func addLeadingZeros(int: Int32) -> String {
